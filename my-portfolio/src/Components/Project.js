const Project=()=>{
    ...
    <div className="col-sm-4 col-3 g-1 wrapper bg-secondary">
...
Places By using Open CV
           ...
           <div className="col-sm-4 col-4 p-1 "> <a className="alink" href="https://motherbeauty.vercel.app/"> <p className="linktopro p-3"> FACE MASK DETECTION </p> </a></div>
      
     
          
    </div>
    <div className="row pro-container mt-5 ">
    <div className="col-sm-4 col-3 g-1 p wrapper bg-secondary">
        ...
        <p  className=" para col-sm-4  col-6 g-0 p-2">It is a web development app using the Spring Boot framework by Java
           ...
           <div className="col-sm-4 col-4 p-1 "><a className="alink" href="https://motherbeauty.vercel.app/"  ><p className="linktopro p-3">FOOTWEAR SALES APP</p></a> </div>
    ...
    <div className="col-sm-4 col-3  g-1 wrapper bg-secondary"> 
        ...
        <p  className=" para col-sm-4 col-6 g-1 p-2">It is a front-end web development app using Reactjs
           ...
           <div className="col-sm-4 col-4 p-1 "> <a className="alink " href="https://motherbeauty.vercel.app/"  ><p className="linktopro p-3 ">WOMEN'S BEAUTY PRODUCTS SALES APP</p></a></div> 
