...
Places By using Open CV
           ...
           <div className="col-sm-4 col-12 p-1 prosubtitle "> <a className="alink" href="https://motherbeauty.vercel.app/"> <p className="linktopro p-3"> FACE MASK DETECTION </p> </a></div>
    ...
    <div className="col-sm-4 col-6 g-1 p wrapper bg-secondary">
        ...
        <p  className=" para col-sm-4  col-6 g-0 p-2">It is a web development app using the Spring Boot framework by Java
           ...
           <div className="col-sm-4 col-12 p-1 prosubtitle "><a className="alink" href="https://motherbeauty.vercel.app/"  ><p className="linktopro p-3">FOOTWEAR SALES APP</p></a> </div>
